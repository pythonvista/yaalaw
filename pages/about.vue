  ...
  <section class="py-10 bg-white sm:py-16 lg:py-24">
    <div class="max-w-5xl px-4 mx-auto sm:px-6 lg:px-8">
      <div class="mx-auto text-left md:max-w-lg lg:max-w-2xl md:text-center">
        <h2
          class="text-3xl text-center font-bold leading-tight text-black sm:text-4xl lg:text-5xl lg:leading-tight"
        >
          About
          <span class="relative inline-block">
            <span
              class="absolute inline-block w-full h-2 bg-red-300 bottom-1.5"
            ></span>
          </span>
      ...
      <div
        class="grid grid-cols-1 mt-8 md:mt-20 w-full place-content-center place-items-center gap-y-6 md:grid-cols-3 gap-x-10"
      >
        <div class="xs:col-span-1 md:col-span-2 xs:order-last md:order-first">
          ...
          <div class="xs:col-span-3 md:col-span-1 xs:order-first md:order-last w-full flex xs:justify-center md:justify-end items-center">
            <img
