      ...
      >
        <v-card>
          <v-toolbar dark color="#8c4f0d">
            ...
            <v-spacer></v-spacer>
            <v-toolbar-items>
              <v-btn variant="text" color="white" @click="dialog = false"> Close </v-btn>
            </v-toolbar-items>
          </v-toolbar>
          <div class="p-5">
            <div class="flex justify-start items-center gap-3">
              ...
              >
                {{ dform.name }} <br />
                <p class="italic font-mono font-light text-xl">{{ dform.title }}</p>
    ...
    data: () => ({
      ...
      teams: [
        ...
        },
        {
          ...
          descr:
            'Christiana Aderonke Akanniis an associate at YAA Law Consult. A dexterous legal practitioner in legal research, corporate practice, family law. Christiana obtained her Bachelor of law (LLB) degree from University of Abuja. Education - Nigerian Law School (BL) - Univerity of Abuja (LLB) Membership and Professional Associations * Nigerian Bar Association <br> <br> Education <br>- Nigerian Law School (BL) <br> - Univerity of Abuja (LLB) <br> <br> Membership and Professional Associations <br>* Nigerian Bar Association',
        },
        {
